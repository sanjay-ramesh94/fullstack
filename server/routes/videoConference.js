...
// Export Video Conference bookings
  ...
  try {
    ...
    if (format === 'csv') {
      ...
      const csvHeaders = [
        ...
        'End Time', 'Purpose', 'Meeting Type', 'Participants', 'Recording Required', 'Status', 'Created At'
      ].join(',');
      ...
      const csvRows = bookings.map(booking => [
        ...
        booking.endTime,
        booking.purpose,
        booking.meetingType || 'N/A',
        booking.expectedParticipants || 'N/A',
        booking.requiresRecording ? 'Yes' : 'No',
        booking.status,
      ...
      res.attachment('video-conference-bookings.csv');
    ...
    console.error('Video Conference export error:', error);
