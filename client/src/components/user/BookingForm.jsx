...
const BookingForm = ({ selectedDate, existingBookings, onBookingSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.department || 
        !formData.purpose || !formData.startTime || !formData.endTime) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <h3 className="text-xl font-semibold text-gray-800 mb-6">Book Your Slot</h3>
