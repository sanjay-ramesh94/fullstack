// src/components/user/LabBookingForm.jsx
import React, { useState, useEffect } from 'react';
import { api } from '../../services/api';

const LabBookingForm = ({ selectedDate, existingBookings, onBookingSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.department || !formData.purpose || 
        ...
        !formData.labType || !formData.experimentType ||
    ...
    try {
      ...
      await api.post('/lab', bookingData);
      onBookingSuccess();
    } catch (error) {
      setError(error.response?.data?.message || 'Failed to create lab booking');
    }
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <h3 className="text-xl font-semibold text-gray-800 mb-6">Book Laboratory</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Type of experiment or activity"
              />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Name of supervising faculty/staff"
              />
            </div>

            <div>
              <label htmlFor="supervisorContact" className="block text-sm font-medium text-gray-700 mb-2">
                Supervisor Contact *
              </label>
              <input
                type="text"
          ...
          <div>
            ...
            <textarea
              ...
              rows="2"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Any special setup or instructions for the lab session"
            />
          </div>
