              ...
              {halls.map((hall, index) => {
                ...
                return (
                  <div 
                    ...
                    className={`${colorClasses[hall.color]} rounded-3xl shadow-xl p-10 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border-2 cursor-pointer`}
                  >
                    <div className="mb-8">
                      <img
                        src={hall.image}
                    ...
                    <div className="mt-8">
                      <span className={`inline-block bg-gradient-to-r from-${hall.color}-600 to-${hall.color}-700 text-white font-bold py-4 px-8 rounded-2xl text-lg shadow-lg`}>
                        Book Now →
                      </span>
                    </div>
                  </div>
