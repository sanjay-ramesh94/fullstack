          ...
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Your Laboratory booking request has been sent to the admin for approval. You will receive an email once your booking is approved.
              </p>
                              ...
                              <div className="flex items-center space-x-4 text-xs text-red-600">
                                ...
                                {booking.labType && (
                                  <span className="flex items-center">
                                    ...
                                    {booking.labType} - {booking.experimentType}
                                  </span>
                                )}
                              </div>
                            </div>
