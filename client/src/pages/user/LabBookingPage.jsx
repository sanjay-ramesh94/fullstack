// src/pages/user/LabBookingPage.jsx
import React, { useState, useEffect } from 'react';
import { Navigate, useNavigate } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';
import BookingCalendar from '../../components/user/BookingCalendar';
import LabBookingForm from '../../components/user/LabBookingForm';
...
const LabBookingPage = () => {
  ...
  const fetchBookingsForDate = async (date) => {
    ...
    try {
      ...
      const response = await api.get(`/lab/date/${dateStr}`);
        ...
        <div className="bg-white shadow-sm border-b">
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              <h1 className="text-2xl font-bold text-gray-800">Laboratory Booking</h1>
              <button
          ...
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Your Laboratory booking has been confirmed successfully. You will receive a confirmation email shortly.
              </p>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Book Laboratory</h1>
              {user && (
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <p className="text-gray-600">Select a date and time for your laboratory booking</p>
        </div>
          ...
          <div className="space-y-6">
              ...
              <>
                <div className="bg-white rounded-lg shadow-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">
                    Laboratory Bookings for {selectedDate.toDateString()}
                  </h3>
                  ...
                  {loadingBookings ? (
                      ...
                      {existingBookings.map(booking => (
                        <div key={booking._id} className="bg-red-50 border border-red-200 rounded p-3">
                          ...
                          <p className="text-sm text-red-600 mt-1">
                            {booking.labType} - {booking.experimentType} ({booking.numberOfStudents} students)
                          </p>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-gray-500 text-sm">Laboratory is available!</p>
                    </div>
                  )}
                </div>
            ...
            {!selectedDate && (
              <div className="bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <p className="text-gray-600">Choose an available date from the calendar to proceed with laboratory booking</p>
              </div>
            )}
          </div>
        </div>
