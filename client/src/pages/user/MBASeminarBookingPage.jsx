          ...
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Your MBA Seminar Hall booking request has been sent to the admin for approval. You will receive an email once your booking is approved.
              </p>
                            ...
                            <div className="ml-6 space-y-1">
                              ...
                              <div className="flex items-center space-x-4 text-xs text-red-600">
                                <span className="flex items-center">
                                  ...
                                  {booking.expectedStudents} students
                                </span>
                                <span className="flex items-center">
                                  <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
