  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600">Welcome back, {admin.name || admin.email}</p>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Dashboard Stats - Only Booked Days This Month */}
                    ...
                    {date && (
                      <button
                        ...
                        className={`
                          ...
                          ${getDateStyles(date, selectedDate, bookedDates)}
                        `}
                        title={
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">Future Bookings</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-4 h-4 bg-green-200 border border-green-400 rounded mr-2"></div>
                    <span className="text-gray-700">Past Bookings</span>
                  </div>
                </div>
              </div>
            </div>
...
// Enhanced Event Card Component with better styling and information
const EventCard = React.memo(({ event, type, selectedDate }) => {
  ...
  const getTimeStatus = () => {
    ...
    // Create the actual event date and time using the selected date
    ...
    if (isUpcoming) {
      ...
      if (timeDiff > 0) {
        ...
        // Event has already started, check if it's still ongoing
